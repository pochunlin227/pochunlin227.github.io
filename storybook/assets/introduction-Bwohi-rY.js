import{j as n}from"./jsx-runtime-47EJ0cPw.js";import{useMDXComponents as r}from"./index-7Rj9iKEt.js";import{M as d}from"./blocks-CVg-7iWZ.js";import"./iframe-DsdvttKI.js";import"./preload-helper-Dp1pzeXC.js";function i(s){const e={code:"code",h1:"h1",h2:"h2",li:"li",p:"p",strong:"strong",ul:"ul",...r(),...s.components};return n.jsxs(n.Fragment,{children:[n.jsx(d,{title:"Introduction"}),`
...
`,n.jsxs(e.li,{children:[n.jsx(e.strong,{children:"Guides"}),` — 設計指南文件(原生 React + 純 CSS 實作):Colors 色票卡、
Typography 字級規範表、Tokens(Spacing / Radius / Shadows / Breakpoints)。`]}),`
`,n.jsxs(e.li,{children:[n.jsx(e.strong,{children:"Foundations"}),` — 色票(Colors)、間距與圓角(Spacing & Radii)、字體(Typography)。
全部對應 `,n.jsx(e.code,{children:"globals.css"})," 中的 design tokens。"]}),`
`,n.jsxs(e.li,{children:[n.jsx(e.strong,{children:"Components"})," — 通用元件:",n.jsx(e.code,{children:"Button"}),`(標準按鈕,variant × size × loading,
CSS Modules + tokens)。`]}),`
`,n.jsxs(e.li,{children:[n.jsx(e.strong,{children:"Common"})," — 共用元件:",`
`,n.jsxs(e.ul,{children:[`
`,n.jsxs(e.li,{children:[n.jsx(e.code,{children:"Button"})," — 來自 Figma Brand → Elements(",n.jsx(e.code,{children:"danger"})," 為 SSO 擴充)。"]}),`
`,n.jsxs(e.li,{children:[n.jsx(e.code,{children:"Nav"}),"、",n.jsx(e.code,{children:"MemberCard"}),"、",n.jsx(e.code,{children:"CarouselControls"}),` — 來自 Figma「Coseeing」→ Elements,
三個響應式斷點(mobile/tablet/desktop)合併為單一元件;icon 以
currentColor inline SVG 實作,logo 與照片資產在 `,n.jsx(e.code,{children:"public/brand/"}),"。"]}),`
...
`]}),`
`]}),`
`,n.jsxs(e.li,{children:[n.jsx(e.strong,{children:"Center"})," — SSO center 專屬的組合元件:",n.jsx(e.code,{children:"AuthPage"})," 版型、",n.jsx(e.code,{children:"CoseeingIdentityCard"}),"。"]}),`
`]}),`
