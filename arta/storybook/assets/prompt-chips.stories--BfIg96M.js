import{s as i,d as o}from"./helpers-BwuIyHmI.js";const e={title:"Product Patterns/Forms & Selection/AI Prompt Chips",parameters:o(["AI prompt-suggestion chips (dashboard) — member language, verbatim from the product. The highlighted chip is the in-product lending demand signal the charge card answers.","","**States** default · evidence-highlight (`text.ai` border). **Mobile** full-width column."].join(`
`))},a={render:()=>`
    ...
    </div>`,parameters:i(`<div class="arta-prompt">
...
}`,...(r=(t=a.parameters)==null?void 0:t.docs)==null?void 0:r.source}}};const n=["Chips"];export{a as Chips,n as __namedExportsOrder,e as default};
