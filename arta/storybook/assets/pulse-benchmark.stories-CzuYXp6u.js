import{s,d as o}from"./helpers-BwuIyHmI.js";const i={title:"02 Components/Data display/Peer benchmark",parameters:o(['Arta Pulse community benchmark card — "compare your portfolio to other Arta members", small donut + insights CTA.'].join(`
`))},t={render:()=>`
  ...
  <button class="arta-btn arta-btn--secondary">See insights →</button>
</div>`)};var a,r,e;t.parameters={...t.parameters,docs:{...(a=t.parameters)==null?void 0:a.docs,source:{originalSource:`{
  render: () => \`
    <div class="arta-keyterms" style="max-width:460px">
      <div class="arta-keyterms__title">Benchmarks</div>
      <p style="color:var(--arta-sys-color-text-tertiary);font-size:12px;letter-spacing:.06em">3 BENCHMARKS · 1,046 ANSWERS</p>
...
}`,...(e=(r=t.parameters)==null?void 0:r.docs)==null?void 0:e.source}}};const c=["Card"];export{t as Card,c as __namedExportsOrder,i as default};
