import{s as n,d as i}from"./helpers-BwuIyHmI.js";const l={title:"Product Patterns/Data & Charts/Education Chart",parameters:i(["Education modal chart — mono-caps title + two comparison lines. Chart primitives are tokens (`chartline.accent/secondary/grid/label-color`)."].join(`
`))},e={render:()=>`
...
</svg>`)};var t,a,r;e.parameters={...e.parameters,docs:{...(t=e.parameters)==null?void 0:t.docs,source:{originalSource:`{
  render: () => \`
    <div class="sb-h">open-end vs closed-end vehicle</div>
    <div class="arta-keyterms" style="max-width:520px">
      <div class="arta-keyterms__title">Open-ended vehicle would outperform a closed-ended fund when gross returns are equal</div>
...
}`,...(r=(a=e.parameters)==null?void 0:a.docs)==null?void 0:r.source}}};const o=["Comparison"];export{e as Comparison,o as __namedExportsOrder,l as default};
