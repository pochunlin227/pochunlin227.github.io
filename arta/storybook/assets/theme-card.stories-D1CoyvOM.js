import{s as d,d as c}from"./helpers-BwuIyHmI.js";const h={title:"Product Patterns/Cards & Catalog/Theme Card",parameters:c(["Micro Index theme card. The **icon carries the accent color**; the card stays neutral glass (`alpha.white-8`) so a 9-card grid never turns into a rainbow.","","**States** static (navigation card — press feedback only). **Tokens** `arta.cmp.theme-card.*`. **Mobile** single column."].join(`
`))},e={render:()=>`
