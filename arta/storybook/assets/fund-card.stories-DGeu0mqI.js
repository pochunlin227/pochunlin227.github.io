...
`))},a={render:()=>`
    ...
    <div class="arta-fund-grid" style="display:grid;grid-template-columns:repeat(auto-fill,minmax(200px,1fr));gap:14px;max-width:680px">
      ${[["K***","Private Equity","S$10K","POPULAR","var(--arta-sys-gradient-card-art-3)"],["W********","Private Equity","S$25K","","var(--arta-sys-gradient-card-art-3)"],["F*******","Venture Capital","S$250K","NICHE","var(--arta-sys-gradient-card-art-2)"]].map(([i,n,e,d,l])=>`
        <div class="arta-fund" style="background:${l}">
          ...
          <div class="arta-fund__foot">
            ${d?`<span class="arta-fund__badge">${d}</span>`:'<span style="opacity:.8">⧈</span>'}
...
</div>`)};var s,r,t;a.parameters={...a.parameters,docs:{...(s=a.parameters)==null?void 0:s.docs,source:{originalSource:`{
  render: () => \`
    <div class="sb-h">masked names · POPULAR / NICHE badges · S$ minimums</div>
    <div class="arta-fund-grid" style="display:grid;grid-template-columns:repeat(auto-fill,minmax(200px,1fr));gap:14px;max-width:680px">
