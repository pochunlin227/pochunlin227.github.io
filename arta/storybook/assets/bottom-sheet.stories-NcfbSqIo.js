const s={title:"02 Components/Sheets/Bottom sheet"},e={render:()=>`
    ...
    <p style="max-width:56ch;color:var(--arta-sys-color-text-secondary);font-size:13px;margin-top:16px">
      ...
      doubles as a scroll-completion affordance before enabling "Agree".</p>`};var t,a,r;e.parameters={...e.parameters,docs:{...(t=e.parameters)==null?void 0:t.docs,source:{originalSource:`{
  render: () => \`
    <div style="max-width:400px;background:var(--arta-sys-gradient-acquisition);padding-top:var(--arta-sys-space-section-gap);border-radius:var(--arta-sys-radius-media);overflow:hidden">
      <div class="arta-sheet">
        <div class="arta-sheet__handle"></div>
...
}`,...(r=(a=e.parameters)==null?void 0:a.docs)==null?void 0:r.source}}};const i=["LegalSheet"];export{e as LegalSheet,i as __namedExportsOrder,s as default};
