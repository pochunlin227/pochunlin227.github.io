import{s as n,d as i}from"./helpers-BwuIyHmI.js";const l={title:"07 Product Reference/Data & Charts/Education Chart",parameters:i(["Education modal chart — mono-caps title + two comparison lines. Chart primitives are tokens (`chartline.accent/secondary/grid/label-color`)."].join(`
`))},e={render:()=>`
