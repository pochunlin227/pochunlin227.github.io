...
`))},a={render:()=>`
    ...
    <div class="arta-fund-grid" style="display:grid;grid-template-columns:repeat(auto-fill,minmax(200px,1fr));gap:14px;max-width:680px">
      ${[["K***","Private Equity","S$10K","POPULAR","var(--arta-sys-gradient-card-art-3)"],["W********","Private Equity","S$25K","","var(--arta-sys-gradient-card-art-3)"],["F*******","Venture Capital","S$250K","NICHE","var(--arta-sys-gradient-card-art-2)"]].map(([t,n,e,s,l])=>`
        <div class="arta-fund" style="background:${l}">
          <div><div class="arta-fund__name">${t}</div><div class="arta-fund__cat">${n}</div></div>
...
</div>`)};var d,r,i;a.parameters={...a.parameters,docs:{...(d=a.parameters)==null?void 0:d.docs,source:{originalSource:`{
  render: () => \`
    <div class="sb-h">masked names · POPULAR / NICHE badges · S$ minimums</div>
    <div class="arta-fund-grid" style="display:grid;grid-template-columns:repeat(auto-fill,minmax(200px,1fr));gap:14px;max-width:680px">
...
}`,...(i=(r=a.parameters)==null?void 0:r.docs)==null?void 0:i.source}}};const o=["Variants"];export{a as Variants,o as __namedExportsOrder,u as default};
