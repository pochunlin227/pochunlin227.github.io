import{s as i,d as l}from"./helpers-BwuIyHmI.js";const d={title:"02 Components/Data display/Allocation treemap",parameters:l(["Micro Index review treemap. Tile weight is expressed through the grid template; **hover raises the tile and reveals the white % chip**.","","**Tokens** `arta.cmp.treemap.*`. **Mobile** re-grids to 2 columns."].join(`
`))},a={render:()=>`
