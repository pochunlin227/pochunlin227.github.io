import{s as c,d as r}from"./helpers-BwuIyHmI.js";const o={title:"02 Components/Rows/Contact rows",parameters:r([`People & Groups — verified Arta expert contacts with shield badge. Human escalation as a navigation object; the Arta Card's "Talk to a human" states route here, not to a new surface.`,"","No interactive states by design — verification is not toggleable UI. **Tokens** `arta.cmp.contact.*`."].join(`
`))},a={render:()=>`
