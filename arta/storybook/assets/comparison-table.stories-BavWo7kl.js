import{s,d}from"./helpers-BwuIyHmI.js";const i={title:"02 Components/Tables/Comparison table",parameters:d(["Two-column comparison table (Tax Advantage pattern). **Mobile** — wrap in `.arta-scroll-x`: the card scrolls horizontally, the page never does.","","**Tokens** `arta.cmp.table.*`."].join(`
`))},t={render:()=>`
