import{s as i,d as r}from"./helpers-BwuIyHmI.js";const n={title:"Product Patterns/People & Trust/Arta Takeaway",parameters:r(['"The Arta Takeaway" — three-column summary closing every education page, here carrying the Arta Card story.',"","**Tokens** `arta.cmp.takeaway.*`. **Mobile** columns stack."].join(`
`))},a={render:()=>`
...
}`,...(t=(s=a.parameters)==null?void 0:s.docs)==null?void 0:t.source}}};const l=["ThreeColumns"];export{a as ThreeColumns,l as __namedExportsOrder,n as default};
