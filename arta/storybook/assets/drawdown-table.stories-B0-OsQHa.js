import{s,d as o}from"./helpers-BwuIyHmI.js";const l={title:"07 Product Reference/Data & Charts/Drawdown Table",parameters:o(['Scorecard drawdown events — the three worst drops with recovery math. Unrecovered events show "–", not zero: absence of data is not a number.',"","**Mobile** 7 columns always scroll inside `.arta-scroll-x`. **Tokens** `arta.cmp.table.*` + `sys.status.danger` for losses."].join(`
`))},t={render:()=>`
