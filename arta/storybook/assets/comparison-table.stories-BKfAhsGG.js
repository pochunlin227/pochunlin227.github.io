import{s,d}from"./helpers-BwuIyHmI.js";const i={title:"07 Product Reference/Data & Charts/Comparison Table",parameters:d(["Two-column comparison table (Tax Advantage pattern). **Mobile** — wrap in `.arta-scroll-x`: the card scrolls horizontally, the page never does.","","**Tokens** `arta.cmp.table.*`."].join(`
`))},t={render:()=>`
...
</div>`)};var e,a,r;t.parameters={...t.parameters,docs:{...(e=t.parameters)==null?void 0:e.docs,source:{originalSource:`{
  render: () => \`
    <div class="sb-h">side text + table, wraps under 640px</div>
    <div style="display:flex;gap:40px;flex-wrap:wrap;max-width:820px">
      <div style="flex:1;min-width:260px">
...
}`,...(r=(a=t.parameters)==null?void 0:a.docs)==null?void 0:r.source}}};const n=["WithContext"];export{t as WithContext,n as __namedExportsOrder,i as default};
