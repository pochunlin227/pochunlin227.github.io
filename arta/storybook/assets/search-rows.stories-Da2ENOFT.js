import{s as l,d as h}from"./helpers-BwuIyHmI.js";const A={title:"07 Product Reference/Forms & Selection/Search Result Rows",parameters:h(['"Search stocks & ETFs" result rows — ticker chip, name, price, solid green/red change pill.',"","**States** default · hover/highlight (`surface.raised`). **Mobile** long fund names wrap to two lines; price + pill stay pinned right."].join(`
`))},a={render:()=>`
    <div class="sb-h">third row shows the hover/highlight state</div>
    <div style="max-width:520px">
      ${[["A","Agilent Technologies Inc.","S$142.92","+0.00%","pos",""],["AA","ALCOA CORP","S$32.10","-0.01%","neg",""],["AAON","AAON Inc.","S$95.51","+0.01%","pos","background:var(--arta-sys-color-surface-raised)"],["AAXJ","iShares MSCI All Country Asia ex Japan Index Fund","S$73.01","+0.00%","pos",""]].map(([n,c,t,i,p,o])=>`
        <div class="arta-ticker-row" style="${o}">
          <span class="arta-ticker-chip">${n}</span>
          <span class="arta-ticker-row__name">${c}</span>
