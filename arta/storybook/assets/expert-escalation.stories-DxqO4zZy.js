import{s as r,d as l}from"./helpers-BwuIyHmI.js";const o={title:"Product Patterns/People & Trust/Expert Escalation",parameters:l([`Named-expert escalation modal (Family Office Service). Two details worth copying: the expert is **named**, and the question list includes the anti-sell question ("why might this NOT be right for me?") — honesty as premium, verbatim from Arta's product.`].join(`
`))},t={render:()=>`
    ...
    </div>`,parameters:r(`<div class="arta-keyterms" style="text-align:center">
  ...
  <button class="arta-btn arta-btn--inverse" style="width:100%">Schedule consultation</button>
  <button class="arta-btn arta-btn--secondary" style="width:100%">Send a message on Arta</button>
</div>`)};var e,a,s;t.parameters={...t.parameters,docs:{...(e=t.parameters)==null?void 0:e.docs,source:{originalSource:`{
  render: () => \`
    <div class="arta-keyterms" style="max-width:420px;text-align:center">
      <div style="font-size:28px">✻</div>
      <div class="arta-keyterms__title" style="text-align:center">Arta Family Office Service</div>
...
}`,...(s=(a=t.parameters)==null?void 0:a.docs)==null?void 0:s.source}}};const d=["Modal"];export{t as Modal,d as __namedExportsOrder,o as default};
