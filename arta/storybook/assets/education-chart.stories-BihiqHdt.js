import{s as n,d as i}from"./helpers-BwuIyHmI.js";const l={title:"02 Components/Data display/Education chart",parameters:i(["Education modal chart — mono-caps title + two comparison lines. Chart primitives are tokens (`chartline.accent/secondary/grid/label-color`)."].join(`
`))},e={render:()=>`
