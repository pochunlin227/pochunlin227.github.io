import{s as o,d as c}from"./helpers-BwuIyHmI.js";const v={title:"02 Components/Catalog cards/Benefit card",parameters:c(['"Why we love it" numbered education card. Same dim-siblings physics as the catalog: focus one, the rest recede.',"","| State | Class |","|---|---|","| Default | `.arta-benefit` (all gradients live) |","| Focused | `.focused` + grid `.has-focus` (siblings drop opacity) |","","**Tokens** `arta.cmp.benefit.*`. **Mobile** stacks to one column; focus still works."].join(`
`))},e={render:()=>`
...
}`,...(i=(s=e.parameters)==null?void 0:s.docs)==null?void 0:i.source}}};const b=["FocusDims"];export{e as FocusDims,b as __namedExportsOrder,v as default};
