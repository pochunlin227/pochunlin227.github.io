import{s as n,d as i}from"./helpers-BwuIyHmI.js";const r={title:"Product Patterns/Forms & Selection/Segmented Pills",parameters:i(["Segmented pill control (risk levels, investment amounts). Selected = inverse (white) pill with dark text.","","**States** default · selected (inverse). **Tokens** `arta.cmp.toggle.*`. **Mobile** wraps to a second line — never shrinks below `sys.size.control-compact`."].join(`
`))},e={render:()=>`
