import{s as o,d as c}from"./helpers-BwuIyHmI.js";const v={title:"Product Patterns/Cards & Catalog/Benefit Card",parameters:c(['"Why we love it" numbered education card. Same dim-siblings physics as the catalog: focus one, the rest recede.',"","| State | Class |","|---|---|","| Default | `.arta-benefit` (all gradients live) |","| Focused | `.focused` + grid `.has-focus` (siblings drop opacity) |","","**Tokens** `arta.cmp.benefit.*`. **Mobile** stacks to one column; focus still works."].join(`
`))},e={render:()=>`
    <div class="sb-h">Click one — focus dims siblings</div>
    <div class="arta-benefit-grid" id="benGrid" style="max-width:820px">
      ${[["#1","Market upside, no market downside","Combines underlying bonds and options to protect your principal while capturing market upside.","var(--arta-sys-gradient-card-art-2)"],["#2","Global diversification","Benchmarked to three global indexes: the S&P 500, the EURO STOXX 50, and the Tokyo Stock Price Index.","var(--arta-sys-gradient-card-art-3)"],["#3","Optimized performance","Gives a higher weighting to the index that performs best over the period.","var(--arta-sys-gradient-card-art-1)"]].map(([i,r,d,n])=>`
        <div class="arta-benefit" style="background:${n}" onclick="
          ...
          <div class="arta-benefit__num">${i}</div>
...
}`,...(t=(s=e.parameters)==null?void 0:s.docs)==null?void 0:t.source}}};const b=["FocusDims"];export{e as FocusDims,b as __namedExportsOrder,v as default};
