const b={title:"Components/Form Field"},e=({label:u,value:f="",placeholder:m="",help:r="",error:h=!1,disabled:s=!1,prefix:l=""})=>`
  <div class="arta-field${h?" arta-field--error":""}${s?" arta-field--disabled":""}">
    ...
    </div>`};var i,t,o;a.parameters={...a.parameters,docs:{...(i=a.parameters)==null?void 0:i.docs,source:{originalSource:`{
  render: () => \`
    <div class="sb-col">
      \${field({
    label: 'Employer',
...
}`,...(o=(t=a.parameters)==null?void 0:t.docs)==null?void 0:o.source}}};var c,d,p;n.parameters={...n.parameters,docs:{...(c=n.parameters)==null?void 0:c.docs,source:{originalSource:`{
  render: () => \`
    <div class="sb-col">
      <div class="sb-h">Income step — one question per screen, reassurance attached</div>
      \${field({
...
}`,...(p=(d=n.parameters)==null?void 0:d.docs)==null?void 0:p.source}}};const v=["States","SensitiveMoment"];export{n as SensitiveMoment,a as States,v as __namedExportsOrder,b as default};
