import{s as n,d as c}from"./helpers-BwuIyHmI.js";const i={title:"Product Patterns/Data & Charts/Sector Composition",parameters:c(["Twin donuts (portfolio vs benchmark) sharing one color legend. Comparison is **layout, not a new component** — same donut primitive, two instances.","","**Tokens** donut + `.arta-legend`. **Mobile** donuts stack, legend below."].join(`
`))},a={render:()=>`
