import{t as c}from"./tokens.flat-DQgVInkP.js";const v={title:"01 Foundations/Spacing & Radius"},e={render:()=>'<div class="sb-h">arta · ref · space (4px grid)</div>'+c.ref.filter(r=>r.path.startsWith("arta.ref.space.")).map(r=>`
