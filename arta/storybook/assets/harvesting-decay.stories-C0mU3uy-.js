import{s as i,d as c}from"./helpers-BwuIyHmI.js";const v={title:"07 Product Reference/Data & Charts/Harvesting Decay",parameters:c(["Tax-loss harvesting potential by year — year dot, violet fill bar, value. A timeline told as data.","","**Tokens** `arta.cmp.decay.*`."].join(`
`))},a={render:()=>`
