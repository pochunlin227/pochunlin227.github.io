import{s as n,d as l}from"./helpers-BwuIyHmI.js";const p={title:"02 Components/Form controls/Tilt row",parameters:l(["Per-sector tilt row (AMP personalization). Three tilt states live **in the pill label** (Increased / Neutral / Decreased); the row itself never changes color — tilt is data, not celebration.","","**Tokens** `arta.cmp.sector.*`. **Mobile** description wraps; pill stays pinned right."].join(`
`))},e={render:()=>`
