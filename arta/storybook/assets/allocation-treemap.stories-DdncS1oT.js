import{s as p,d as c}from"./helpers-BwuIyHmI.js";const d={title:"07 Product Reference/Data & Charts/Allocation Treemap",parameters:c(["Micro Index review treemap. Tile weight is expressed through the grid template; **hover raises the tile and reveals the white % chip**.","","**Tokens** `arta.cmp.treemap.*`. **Mobile** re-grids to 2 columns."].join(`
`))},a={render:()=>`
