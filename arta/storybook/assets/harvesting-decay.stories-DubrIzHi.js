import{s as t,d as c}from"./helpers-BwuIyHmI.js";const v={title:"02 Components/Data display/Decay chart",parameters:c(["Tax-loss harvesting potential by year — year dot, violet fill bar, value. A timeline told as data.","","**Tokens** `arta.cmp.decay.*`."].join(`
`))},a={render:()=>`
    <div class="sb-h">13.8% → 2.38% over 8 years</div>
    <div class="arta-decay" style="max-width:520px">
      ${[["1Y",13.8],["2Y",6.84],["3Y",5.48],["4Y",4.67],["5Y",4.5],["6Y",4.16],["8Y",2.38]].map(([r,s])=>`
        <div class="arta-decay__row">
          <div class="arta-decay__dot">${r}</div>
...
</div>`)};var d,e,i;a.parameters={...a.parameters,docs:{...(d=a.parameters)==null?void 0:d.docs,source:{originalSource:`{
  render: () => \`
    <div class="sb-h">13.8% → 2.38% over 8 years</div>
    <div class="arta-decay" style="max-width:520px">
...
}`,...(i=(e=a.parameters)==null?void 0:e.docs)==null?void 0:i.source}}};const n=["Timeline"];export{a as Timeline,n as __namedExportsOrder,v as default};
