import{s as i,d}from"./helpers-BwuIyHmI.js";const n={title:"02 Components/Data display/Performance bars",parameters:d(["Post-tax performance bars — white base + violet delta per year. Pure CSS, fluid width.","","**Tokens** `arta.cmp.bars.*`."].join(`
`))},s={render:()=>`
