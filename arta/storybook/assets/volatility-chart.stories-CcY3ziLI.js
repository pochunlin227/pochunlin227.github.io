import{s,d as l}from"./helpers-BwuIyHmI.js";const c={title:"07 Product Reference/Data & Charts/Line Chart & Legend",parameters:l(["Historical-volatility line chart. Portfolio is always the **violet** series (`chartline.accent`); benchmark is grey. The legend row is its own component (`.arta-legend`), reused by the sector donuts.","","Inline SVG, no chart library — every color is a token. **Mobile** the SVG is fluid (viewBox)."].join(`
`))},a={render:()=>`
