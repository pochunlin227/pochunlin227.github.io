import{s as l,d as h}from"./helpers-BwuIyHmI.js";const A={title:"Product Patterns/Forms & Selection/Search Result Rows",parameters:h(['"Search stocks & ETFs" result rows — ticker chip, name, price, solid green/red change pill.',"","**States** default · hover/highlight (`surface.raised`). **Mobile** long fund names wrap to two lines; price + pill stay pinned right."].join(`
`))},a={render:()=>`
